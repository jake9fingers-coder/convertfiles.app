            ...
            <div className="max-w-4xl mx-auto">
                <ScrollReveal className="text-center">
                    ...
                    <p className="text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed mb-10">
                        Convertly processes everything using <strong className="text-white">WebAssembly</strong> — a technology that lets us run FFmpeg directly inside your browser tab. There is no server receiving your files. Nothing is stored. Nothing is logged. You can verify this yourself by opening DevTools → Network while converting.
                    </p>
