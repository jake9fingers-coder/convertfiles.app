...
export function AssistedPasswordConfirmation({ password }: { password: string }) {
    ...
    return (
        <div className="relative flex w-full flex-col items-center">
            <div className="w-full flex-col items-center justify-center gap-4 bg-white p-6 rounded-2xl border border-dark-200 shadow-sm">
                <div className="relative flex w-full flex-col items-start justify-center">
                    <span className="text-sm text-gray-900 font-semibold mb-2">Target Password</span>
                    <div className="mb-4 text-brand-600 font-mono tracking-widest bg-brand-50 px-3 py-2 rounded-lg border border-brand-100 w-full text-center">
                        {password || 'Not set'}
                    </div>

                    <span className="text-sm text-gray-900 font-semibold mb-1">Confirm Password</span>
                    <motion.div
                    ...
                    >
                        <div className="relative h-full w-fit overflow-hidden rounded-lg mx-auto">
                    ...
                    >
                        <motion.input
                            className="h-full w-full rounded-xl border-2 bg-white px-3.5 py-3 tracking-[0.4em] outline-none placeholder:tracking-normal focus:border-brand-500 text-gray-900 transition-colors"
                            type="password"
                    ...
                    {passwordsMatch && confirmPassword.length > 0 && (
                        <p className="text-green-600 text-sm mt-2 text-center w-full font-medium">Passwords match!</p>
                    )}
                </div>
            </div>
        </div>
