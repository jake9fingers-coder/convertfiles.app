    ...
    return (
        <div className="bg-white border border-dark-200 rounded-xl shadow-sm p-6 space-y-6 animate-slide-up">
            ...
            <button
                onClick={onConvert}
                disabled={loading}
                className="w-full py-4 px-6 text-base font-semibold bg-brand-500 text-dark-900 rounded-lg hover:bg-brand-600 hover:text-white active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-150 shadow-sm hover:shadow-md"
